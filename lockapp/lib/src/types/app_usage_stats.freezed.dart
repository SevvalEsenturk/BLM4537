...
abstract class $AppUsageStatsCopyWith<$Res> {
  factory $AppUsageStatsCopyWith(
          AppUsageStats value, $Res Function(AppUsageStats) then) =
...
abstract class _$$AppUsageStatsImplCopyWith<$Res>
  ...
  factory _$$AppUsageStatsImplCopyWith(
          _$AppUsageStatsImpl value, $Res Function(_$AppUsageStatsImpl) then) =
...
class __$$AppUsageStatsImplCopyWithImpl<$Res>
  ...
  __$$AppUsageStatsImplCopyWithImpl(
      _$AppUsageStatsImpl _value, $Res Function(_$AppUsageStatsImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$AppUsageStatsImpl(
      id: null == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as String,
...
// milliseconds
  ...
  Map<String, dynamic> toJson() {
    return _$$AppUsageStatsImplToJson(
      this,
    );
  }
}
...
abstract class _AppUsageStats extends AppUsageStats {
  const factory _AppUsageStats(
      ...
      required final DateTime updatedAt}) = _$AppUsageStatsImpl;
...
// milliseconds
  ...
  @override
  Map<String, dynamic> toJson() {
    return _$$DailyUsageSummaryImplToJson(
      this,
    );
  }
}
...
abstract class _DailyUsageSummary extends DailyUsageSummary {
  const factory _DailyUsageSummary(
      ...
      required final List<AppUsageStats> topApps,
      required final DateTime createdAt,
      required final DateTime updatedAt}) = _$DailyUsageSummaryImpl;
...
abstract class $WeeklyUsageReportCopyWith<$Res> {
  factory $WeeklyUsageReportCopyWith(
          WeeklyUsageReport value, $Res Function(WeeklyUsageReport) then) =
...
abstract class _$$WeeklyUsageReportImplCopyWith<$Res>
    implements $WeeklyUsageReportCopyWith<$Res> {
  factory _$$WeeklyUsageReportImplCopyWith(_$WeeklyUsageReportImpl value,
...
class __$$WeeklyUsageReportImplCopyWithImpl<$Res>
  ...
  __$$WeeklyUsageReportImplCopyWithImpl(_$WeeklyUsageReportImpl _value,
  ...
  $Res call({
    ...
    return _then(_$WeeklyUsageReportImpl(
      id: null == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as String,
...
// milliseconds
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._topAppsWeekly, _topAppsWeekly) &&
            (identical(other.createdAt, createdAt) ||
                other.createdAt == createdAt) &&
            (identical(other.updatedAt, updatedAt) ||
                other.updatedAt == updatedAt));
  ...
  @override
  Map<String, dynamic> toJson() {
    return _$$WeeklyUsageReportImplToJson(
      this,
    );
  }
}
...
abstract class _WeeklyUsageReport extends WeeklyUsageReport {
  const factory _WeeklyUsageReport(
      ...
      required final List<AppUsageStats> topAppsWeekly,
      required final DateTime createdAt,
      required final DateTime updatedAt}) = _$WeeklyUsageReportImpl;
